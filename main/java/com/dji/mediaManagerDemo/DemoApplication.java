...
public class DemoApplication extends Application {
    ...
    public void onCreate() {
            ...
            public void onRegister(DJIError error) {
                ...
                if(error == DJISDKError.REGISTRATION_SUCCESS) {
                    ...
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), "注册程序成功", Toast.LENGTH_LONG).show();
                        }
                    });
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M || (permissionCheck == 0 && permissionCheck2 == 0)) {
            ...
            Toast.makeText(getApplicationContext(), "注册SDK中，请稍后...", Toast.LENGTH_LONG).show();

        } else {
            Toast.makeText(getApplicationContext(), "请开启所有权限.", Toast.LENGTH_LONG).show();
        }
    }
